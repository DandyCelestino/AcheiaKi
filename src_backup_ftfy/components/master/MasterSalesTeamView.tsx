...
export const MasterSalesTeamView: React.FC<MasterSalesTeamViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* 1. TOPO & BANNER DE GESTÃƒO COMERCIAL */}
      <div className="bg-linear-to-r from-slate-900 via-blue-950 to-indigo-950 text-white p-6 rounded-2xl shadow-md border border-slate-800">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <h1 className="text-xl md:text-2xl font-black tracking-tight text-white flex items-center gap-2">
              ...
              GestÃ£o de Vendedores & Equipe Comercial
            </h1>
            <p className="text-xs text-slate-300 max-w-2xl leading-relaxed">
              SupervisÃ£o central do Administrador Master: acompanhe vendedores atrelados, defina comissÃµes personalizadas, aprove o envio de boletos bancÃ¡rios aos clientes cadastrados e libere comissÃµes apÃ³s a confirmaÃ§Ã£o de pagamento.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              title="Abrir a visÃ£o exata que o vendedor vÃª"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mt-6 pt-5 border-t border-slate-800/80">
          ...
          <div className="bg-slate-800/60 p-3 rounded-xl border border-slate-700/60">
            ...
            <span className="text-[10px] text-emerald-300/80 font-medium mt-0.5 block">PÃ³s-confirmaÃ§Ã£o</span>
          </div>
      ...
      {/* 2. SUB-BARRA DE NAVEGAÃ‡ÃƒO INTERNA */}
      <div className="flex items-center space-x-2 border-b border-slate-200 bg-white p-2 rounded-xl shadow-xs overflow-x-auto">
        ...
        >
          ...
          <span>Hierarquia & AtribuiÃ§Ã£o de Ãreas</span>
        ...
        >
          ...
          <span>Cadastro & GestÃ£o de Vendedores ({salesAgents.length})</span>
        </button>
        ...
        >
          ...
          <span>SolicitaÃ§Ãµes de Boletos & ComissÃµes ({boletoRequests.length})</span>
          {pendingBoletos > 0 && (
        ...
        >
          ...
          <span>Webhooks & LiquidaÃ§Ã£o AutomÃ¡tica</span>
          <span className="ml-1 px-1.5 py-0.5 text-[9px] rounded-md bg-emerald-100 text-emerald-800 font-extrabold">
            Gateways
          </span>
        </button>
        ...
        >
          <Target className="w-4 h-4" />
          <span>Metas Comerciais LanÃ§adas ({commercialGoals.length})</span>
        </button>
      </div>
      ...
      {activeSubTab === 'organogram' && (
        <div className="space-y-6">
          {/* BANNER DE GESTÃƒO CENTRALIZADA */}
          <div className="bg-linear-to-r from-blue-900 to-indigo-900 text-white p-4 rounded-2xl shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-extrabold text-sm text-white">
                  Controle Central de HierarquizaÃ§Ã£o & AtribuiÃ§Ã£o Territorial
                </h4>
                <p className="text-xs text-blue-200 mt-0.5">
                  Vincule consultores a supervisores, distribua bairros de Cachoeiras de Macacu e defina metas por esquadrÃ£o.
                </p>
              </div>
            </div>
            <button
            ...
            >
              <span>Gerenciar Hierarquias e Ãreas</span>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-6 pb-4 border-b border-slate-100">
              <div>
                <h2 className="text-base font-black text-slate-900 flex items-center gap-2">
                  ...
                  Estrutura HierÃ¡rquica da ForÃ§a Comercial
                </h2>
                <p className="text-xs text-slate-500 mt-0.5">
                  Organograma operacional com subordinaÃ§Ã£o direta ao Administrador Master Supremo. Clique nos agentes para gerenciar comissÃµes e dados.
                </p>
              </div>
            ...
            <div className="relative py-4 flex flex-col items-center">
              ...
              <div className="w-full max-w-md bg-linear-to-r from-slate-900 to-indigo-950 text-white rounded-2xl p-4 shadow-lg border-2 border-blue-500/40 text-center relative z-10">
                ...
                <p className="text-[11px] text-blue-300 font-medium">
                  Autoridade Ãšnica de EmissÃ£o de Boletos & LiberaÃ§Ã£o de ComissÃµes
                </p>
                ...
                .map((coord) => {
                  ...
                  return (
                    <div key={coord.id} className="w-full flex flex-col items-center">
                      <div className="w-full max-w-sm bg-blue-50 border-2 border-blue-300 text-slate-900 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all relative">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs font-black text-blue-900">
                            ComissÃ£o: {coord.commissionRatePercent}%
                          </span>
                        </div>
                      ...
                      {/* NÃVEL 2: SUPERVISORES & CONSULTORES */}
                              ...
                              >
                                <div>
                                  ...
                                  <div className="mt-3 grid grid-cols-2 gap-2 bg-slate-50 p-2 rounded-lg text-center text-[11px]">
                                    ...
                                    <div>
                                      <span className="text-slate-500 text-[10px] block">Meta MÃªs</span>
      ...
      {/* ========================================================================= */}
      {/* ABA: HIERARQUIA & ATRIBUIÃ‡ÃƒO DE ÃREAS (MÃ“DULO CENTRALIZADO MASTER) */}
      {/* ========================================================================= */}
      {activeSubTab === 'hierarchy' && (
      ...
      {/* ========================================================================= */}
      {/* ABA 2: CADASTRO & GESTÃƒO COMPLETA DE VENDEDORES */}
      {/* ========================================================================= */}
      {activeSubTab === 'agents' && (
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-xl shadow-xs border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Buscar vendedor por nome, CPF, telefone ou regiÃ£o..."
                value={searchTerm}
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4 bg-slate-50 p-3 rounded-xl border border-slate-100">
                      <div>
                        ...
                        <span className="text-[10px] text-slate-400 block">
                          + R$ {agent.commissionBonusPerActivation} bÃ´nus
                        </span>
                      </div>
                      <div>
                        <span className="text-[10px] text-slate-500 uppercase font-bold block">
                    ...
                    <div className="space-y-1.5 mt-3 text-xs text-slate-600">
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400 flex items-center gap-1">
                          <MapPin className="w-3.5 h-3.5" /> RegiÃ£o:
                        </span>
      ...
      {/* ========================================================================= */}
      {/* ABA 3: SOLICITAÃ‡Ã•ES DE BOLETOS & LIBERAÃ‡ÃƒO DE COMISSÃƒO */}
      {/* ========================================================================= */}
      {activeSubTab === 'boletos' && (
        <div className="space-y-4">
          {/* FILTER BAR */}
          <div className="bg-white p-4 rounded-xl shadow-xs border border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-3">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Buscar por cliente, cÃ³digo do boleto, CPF/CNPJ ou vendedor..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-9 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500"
              />
          ...
          <div className="space-y-3">
            {filteredBoletos.length === 0 ? (
              <div className="bg-white p-12 text-center rounded-2xl border border-slate-200">
                ...
                <h3 className="font-bold text-sm text-slate-800">Nenhuma solicitaÃ§Ã£o encontrada</h3>
                <p className="text-xs text-slate-500 mt-1">
                  NÃ£o hÃ¡ solicitaÃ§Ãµes de boletos para os filtros selecionados.
                </p>
              </div>
            ) : (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        {req.status === 'PENDENTE_EMISSAO'
                          ? 'â³ Pendente de EmissÃ£o pelo Master'
                          : req.status === 'BOLETO_ENVIADO'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-slate-50 p-3.5 rounded-xl border border-slate-100 text-xs">
                    <div>
                      ...
                      <span className="text-[11px] text-slate-500 block">
                        {req.neighborhood} â€¢ {req.clientPhone}
                      </span>
                    </div>
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 p-2.5 rounded-xl text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-emerald-900 font-medium">
                          CompensaÃ§Ã£o bancÃ¡ria capturada via Webhook. ComissÃ£o liberada automaticamente.
                  ...
                  {req.barcodeDigits && (
                    <div className="bg-blue-50/50 p-2.5 rounded-xl border border-blue-100 text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      ...
                      >
                        ...
                        <span>{copiedCode === req.id ? 'Copiado!' : 'Copiar CÃ³digo'}</span>
                      </button>
                    </div>
                  )}
                  ...
                  <div className="flex flex-wrap items-center justify-between pt-2 border-t border-slate-100 gap-2">
                    <div className="text-xs text-slate-500 italic">
                      {req.masterNotes || 'Aguardando aÃ§Ã£o do Administrador Master.'}
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {/* ACTION 2: CONFIRMAR PAGAMENTO & LIBERAR COMISSÃƒO */}
                      {req.status === 'BOLETO_ENVIADO' && (
                        <button
                          onClick={() => {
                            setSelectedBoletoToConfirm(req);
                            setConfirmPaymentNotes(
                              'Pagamento bancÃ¡rio compensado. Estabelecimento ativado e comissÃ£o liberada para o consultor.'
                            );
                          }}
                        ...
                        >
                          ...
                          <span>Confirmar Pagamento & Liberar ComissÃ£o</span>
                        </button>
                      )}

                      {/* ACTION 3: PAGAR COMISSÃƒO VIA PIX */}
                      {req.commissionStatus === 'LIBERADA' && (
                        <button
                          onClick={() => {
                        ...
                        >
                          ...
                          <span>Pagar ComissÃ£o (R$ {req.commissionAmount.toFixed(2)}) via Pix</span>
                        </button>
                      )}
                      ...
                      {req.status !== 'CANCELADO' && req.status !== 'PAGAMENTO_CONFIRMADO' && (
                        <button
                          onClick={() => {
                            if (confirm(`Deseja realmente cancelar a solicitaÃ§Ã£o ${req.code}?`)) {
      ...
      {/* ========================================================================= */}
      {/* ABA: WEBHOOKS & LIQUIDAÃ‡ÃƒO AUTOMÃTICA DE BOLETOS */}
      {/* ========================================================================= */}
      {activeSubTab === 'webhooks' && (
              ...
              >
                <div>
                  ...
                  <div className="mt-3 space-y-1 text-xs text-slate-600 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-400">LocalizaÃ§Ã£o:</span>
                      <span>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500">Defina comissÃµes e metas sob sua supervisÃ£o</p>
                </div>
              </div>
              <button
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="font-bold text-slate-700 block mb-1">NÃ­vel HierÃ¡rquico:</label>
                  <select
                ...
                <div>
                  <label className="font-bold text-slate-700 block mb-1">RegiÃ£o de AtuaÃ§Ã£o:</label>
                  <input
                    type="text"
                    required
                    value={agentForm.assignedRegion}
                    onChange={(e) => setAgentForm({ ...agentForm, assignedRegion: e.target.value })}
                    placeholder="Ex: Papucaia / CastÃ¡lia"
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>

              {/* TAXA DE COMISSÃƒO DEFINIDA PELO MASTER */}
              <div className="bg-blue-50/70 p-3 rounded-xl border border-blue-200 space-y-2">
                <span className="font-black text-blue-900 block text-xs flex items-center gap-1">
                  <Percent className="w-3.5 h-3.5" />
                  ComissÃ£o Decidida pelo Administrador Master:
                </span>
                <div className="grid grid-cols-2 gap-3">
                  <div>
      ...
      {/* ========================================================================= */}
      {/* MODAL: AJUSTAR COMISSÃƒO DO VENDEDOR (MASTER) */}
      {/* ========================================================================= */}
          ...
          <div className="bg-white rounded-2xl max-w-sm w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h3 className="font-black text-sm text-slate-900">ComissÃ£o do Vendedor</h3>
            ...
            <div className="space-y-3 text-xs">
              <p className="text-slate-600">
                ...
                <strong>{selectedAgentForCommission.name}</strong> receberÃ¡ sobre cada contrato pago.
              </p>

              <div>
                <label className="font-bold text-slate-700 block mb-1">
                  Taxa de ComissÃ£o (% sobre valor do plano):
                </label>
                <div className="flex items-center space-x-2">
                  <input
                    type="number"
              ...
              <div>
                <label className="font-bold text-slate-700 block mb-1">
                  BÃ´nus Fixo por AtivaÃ§Ã£o Paga (R$):
                </label>
                <input
                  type="number"
                  min="0"
              ...
              <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 text-[11px] text-slate-500">
                Exemplo: Em um plano Ouro de <strong>R$ 49,90</strong>, o vendedor receberÃ¡{' '}
                <strong className="text-emerald-700">
                  R$ {((49.9 * newCommissionRate) / 100 + newBonusPerActivation).toFixed(2)}
                </strong>{' '}
                de comissÃ£o apÃ³s confirmaÃ§Ã£o do pagamento.
              </div>
      ...
      {selectedBoletoToSend && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h3 className="font-black text-sm text-slate-900">
                    Emitir Boleto BancÃ¡rio: {selectedBoletoToSend.code}
                  </h3>
            ...
            <div className="space-y-3 text-xs">
              <p className="text-slate-600">
                Gere e registre os dados do boleto bancÃ¡rio oficial para envio ao cliente cadastrado
              ...
              <div>
                <label className="font-bold text-slate-700 block mb-1">
                  CÃ³digo Pix Copia e Cola (Bolepix Integrado):
                </label>
                <textarea
                  rows={2}
                  value={boletoPixCode}
              ...
              <div>
                <label className="font-bold text-slate-700 block mb-1">ObservaÃ§Ãµes do Master:</label>
                <input
                  type="text"
                  placeholder="Ex: Boleto registrado no banco ItaÃº, com vencimento em 7 dias."
                  value={boletoNotes}
      ...
      {/* ========================================================================= */}
      {/* MODAL: CONFIRMAR PAGAMENTO & LIBERAR COMISSÃƒO */}
      {/* ========================================================================= */}
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            <div className="flex items-center space-x-3 pb-3 border-b border-slate-100">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  {selectedBoletoToConfirm.code} â€¢ {selectedBoletoToConfirm.clientName}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 text-xs">
              <div className="bg-emerald-50/80 p-3.5 rounded-xl border border-emerald-200 text-emerald-900 space-y-1">
                ...
                <div className="flex justify-between pt-1 border-t border-emerald-200 text-emerald-950 font-bold">
                  <span>ComissÃ£o a Liberar ({selectedBoletoToConfirm.commissionRatePercent}%):</span>
              ...
              <p className="text-slate-500 text-[11px] leading-relaxed">
                Ao confirmar, o status do boleto mudarÃ¡ para{' '}
                <strong className="text-slate-800">PAGAMENTO_CONFIRMADO</strong>, a comissÃ£o do
                vendedor serÃ¡ marcada como <strong className="text-emerald-700">LIBERADA</strong> e o
                cliente/lojista passarÃ¡ a ter status ativo no catÃ¡logo Achei Aqui.
              </p>
      ...
      {/* ========================================================================= */}
      {/* MODAL: PAGAR COMISSÃƒO AO VENDEDOR VIA PIX */}
      {/* ========================================================================= */}
      ...
      {/* ========================================================================= */}
      {/* MODAL: LANÃ‡AR NOVA META COMERCIAL */}
      {/* ========================================================================= */}
      {isNewGoalModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h3 className="font-black text-sm text-slate-900">LanÃ§ar Nova Meta Comercial</h3>
            ...
            >
              <div>
                <label className="font-bold text-slate-700 block mb-1">TÃ­tulo da Meta / Campanha:</label>
                <input
                  type="text"
                  required
                  value={goalForm.title}
                  onChange={(e) => setGoalForm({ ...goalForm, title: e.target.value })}
                  placeholder="Ex: Campanha de ExpansÃ£o Lojistas Cachoeiras"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="font-bold text-slate-700 block mb-1">MÃªs de ReferÃªncia:</label>
                  <input
                    type="text"
                    required
                    value={goalForm.targetMonth}
                    onChange={(e) => setGoalForm({ ...goalForm, targetMonth: e.target.value })}
                    placeholder="MarÃ§o/2026"
              ...
              <div>
                <label className="font-bold text-slate-700 block mb-1">PremiaÃ§Ã£o / BÃ´nus do Vendedor:</label>
                <input
                  type="text"
                  required
