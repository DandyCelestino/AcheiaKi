...
export const NotificationMonitor: React.FC = () => {
  ...
  const [testMessage, setTestMessage] = useState('OlÃ¡! Esta Ã© uma mensagem de teste transacional enviada pelo Achei Aqui.');
  ...
  const handleSendTest = async (e: React.FormEvent) => {
    ...
    if (!testRecipientPhone.trim()) {
      triggerToast('Informe o telefone do destinatÃ¡rio.');
      return;
    }
    ...
    await NotificationService.sendNotification({
      ...
      channel: testChannel,
      title: `Teste de NotificaÃ§Ã£o [${testEventType}]`,
      message: testMessage,
    ...
    setIsSending(false);
    loadLogs();
    triggerToast('NotificaÃ§Ã£o transacional disparada e persistida no Supabase!');
  };
  ...
  return (
    <div className="space-y-6">
      {/* Header com Status do Banco Supabase & EstatÃ­sticas */}
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Registro automÃ¡tico de eventos de pedidos, reservas, provador VIP e autenticaÃ§Ã£o para o comÃ©rcio de Cachoeiras de Macacu.
          </p>
        </div>
      ...
      {/* Grid: FormulÃ¡rio de Disparo Manual + Lista de NotificaÃ§Ãµes */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          ...
          <form onSubmit={handleSendTest} className="space-y-3">
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">DestinatÃ¡rio</label>
              <input
                type="text"
                required
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                >
                  ...
                  <option value="PASSWORD_RESET">CÃ³digo SeguranÃ§a</option>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">ConteÃºdo da Mensagem</label>
              <textarea
                rows={3}
                required
                value={testMessage}
        ...
        {/* Painel Direito: Lista de Logs de Auditoria de NotificaÃ§Ãµes */}
        <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-xs flex flex-col">
          ...
          <div className="p-4 border-b border-slate-100 flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="font-bold text-sm text-slate-900">HistÃ³rico de Disparos Transacionais</h3>
            ...
            <div className="flex items-center space-x-2">
              <div className="relative">
                <input
                  ...
                  placeholder="Buscar destinatÃ¡rio..."
          ...
          <div className="divide-y divide-slate-100 overflow-y-auto max-h-[520px] flex-1">
            {filteredLogs.length === 0 ? (
              <div className="p-12 text-center text-slate-400">
                ...
                <p className="text-sm font-semibold">Nenhuma notificaÃ§Ã£o registrada ainda.</p>
                <p className="text-xs text-slate-400 mt-0.5">
                  FaÃ§a um pedido no marketplace ou dispare um teste para ver os logs em tempo real.
                </p>
              </div>
            ) : (
