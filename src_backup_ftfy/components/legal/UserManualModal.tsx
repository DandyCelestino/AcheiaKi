    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/75 backdrop-blur-xs flex items-center justify-center p-3 sm:p-6 animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-5xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[92vh]">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="text-[10px] font-black uppercase tracking-widest text-amber-400">
                  Normas & TransparÃªncia Legal â€¢ Manual Oficial
                </span>
        ...
        <div className="bg-slate-100 px-4 sm:px-6 pt-3 border-b border-slate-200 flex items-center justify-between gap-2 overflow-x-auto shrink-0">
          <div className="flex space-x-2">
            ...
            >
              ...
              <span>Normas, LGPD & TransparÃªncia</span>
            </button>
          </div>
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-6 text-slate-700 text-xs sm:text-sm leading-relaxed">
              ...
              <div className="p-4 bg-emerald-50/80 border border-emerald-200 rounded-2xl text-emerald-950 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="space-y-1">
                  <div className="flex items-center space-x-2 text-xs font-black uppercase text-emerald-800 tracking-wider">
                    ...
                    <span>Guia Completo para Clientes e UsuÃ¡rios</span>
                  </div>
                  <h3 className="text-sm sm:text-base font-black text-slate-900">
                    Como comprar com seguranÃ§a, agendar serviÃ§os e acompanhar pedidos
                  </h3>
                  <p className="text-xs text-slate-600">
                    Conectamos vocÃª diretamente aos melhores comÃ©rcios, produtores locais e profissionais de Cachoeiras de Macacu.
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all space-y-2">
                  ...
                  <p className="text-xs text-slate-600 pl-8">
                    Clique em <strong>"Entrar"</strong> no topo da pÃ¡gina ou na barra inferior do celular. Selecione a aba <strong>"Criar Nova Conta"</strong>, informe seu nome completo, e-mail, WhatsApp (com DDD) e crie uma senha segura. Seus dados estÃ£o protegidos sob a <strong>Lei Geral de ProteÃ§Ã£o de Dados (LGPD - Lei nÂº 13.709/18)</strong> e nunca sÃ£o vendidos a terceiros.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all space-y-2">
                  ...
                  <p className="text-xs text-slate-600 pl-8">
                    Utilize a barra de pesquisa rÃ¡pida para encontrar produtos, pratos, serviÃ§os ou lojas especÃ­ficas. VocÃª pode filtrar por bairro de Cachoeiras de Macacu (ex.: <em>Centro, Papucaia, JapuÃ­ba, FaraÃ³, CastÃ¡lia, GuapiaÃ§u, Boca do Mato</em>) e conferir a reputaÃ§Ã£o e selos de verificaÃ§Ã£o dos estabelecimentos.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      SeleÃ§Ã£o de Produtos & Montagem da Sacola
                    </h5>
                  </div>
                  <p className="text-xs text-slate-600 pl-8">
                    Abra o produto desejado, selecione opÃ§Ãµes de variaÃ§Ã£o (tamanho, cor, voltagem ou sabor, se houver) e clique em <strong>"Adicionar Ã  Sacola"</strong> ou <strong>"Comprar Agora"</strong>. VocÃª pode adicionar produtos de diferentes lojas e cada lojista responderÃ¡ individualmente pela separaÃ§Ã£o do seu item.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      ConfirmaÃ§Ã£o de Estoque em Tempo Real pelo Lojista
                    </h5>
                  </div>
                  <p className="text-xs text-slate-600 pl-8">
                    Ao enviar o pedido, o sistema notifica o lojista para confirmaÃ§Ã£o imediata da disponibilidade em estoque. No seu painel <strong>"Minha Conta â†’ Meus Pedidos"</strong> vocÃª acompanha o status atualizado:
                  </p>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      Modalidades de Entrega, Retirada & CÃ³digo de SeguranÃ§a
                    </h5>
                  </div>
                  <div className="space-y-2 pl-8 text-xs text-slate-600">
                    <p>
                      â€¢ <strong>Entrega em DomicÃ­lio (Delivery):</strong> O lojista ou entregador parceiro transporta seu pedido atÃ© o endereÃ§o cadastrado.
                    </p>
                    <p>
                      â€¢ <strong>Retirada no BalcÃ£o (Takeaway):</strong> O sistema gera um <strong>CÃ³digo de SeguranÃ§a de 6 dÃ­gitos</strong> exclusivo no seu comprovante. Ao chegar no estabelecimento fÃ­sico, apresente esse cÃ³digo ao atendente para validaÃ§Ã£o e retirada segura do pacote.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      Agendamento de ServiÃ§os & OrÃ§amentos
                    </h5>
                  </div>
                  <p className="text-xs text-slate-600 pl-8">
                    Para eletricistas, encanadores, salÃµes de beleza, diaristas e outros profissionais, utilize o botÃ£o <strong>"Agendar HorÃ¡rio / Solicitar OrÃ§amento"</strong>. Escolha a data desejada e envie detalhes do serviÃ§o diretamente pelo chat integrado ou WhatsApp do prestador.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      Recibos Digitais & AvaliaÃ§Ã£o MÃºtua
                    </h5>
                  </div>
                  <p className="text-xs text-slate-600 pl-8">
                    ApÃ³s a conclusÃ£o do pedido ou atendimento, vocÃª tem acesso ao <strong>Recibo Digital</strong> com todos os detalhes e pode avaliar o atendimento da loja com estrelas e depoimento, ajudando a comunidade e fortalecendo o comÃ©rcio Ã©tico da cidade.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 animate-in fade-in duration-150">
              ...
              <div className="p-4 bg-purple-50/80 border border-purple-200 rounded-2xl text-purple-950 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="space-y-1">
                  <div className="flex items-center space-x-2 text-xs font-black uppercase text-purple-800 tracking-wider">
                    <Store className="w-4 h-4 text-purple-600" />
                    <span>Guia Operacional & Comercial para ComÃ©rcios e Prestadores</span>
                  </div>
                  <h3 className="text-sm sm:text-base font-black text-slate-900">
              ...
              <div className="space-y-4">
                <h4 className="text-sm font-black text-slate-900 flex items-center space-x-2 border-b border-slate-200 pb-2">
                  ...
                  <span>Passo a Passo: Do Cadastro da Loja Ã s Vendas DiÃ¡rias</span>
                </h4>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-purple-300 transition-all space-y-2">
                  ...
                  <p className="text-xs text-slate-600 pl-8">
                    Clique em <strong>"Quero Vender / Cadastrar Minha Loja"</strong>. Preencha o nome fantasia da sua empresa, categoria de atuaÃ§Ã£o (AlimentaÃ§Ã£o, Moda, EletrÃ´nicos, ServiÃ§os, ConstruÃ§Ã£o, etc.), CNPJ ou CPF do responsÃ¡vel, endereÃ§o fÃ­sico com bairro de Cachoeiras de Macacu e o WhatsApp oficial para atendimento.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-purple-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      Modalidades de Planos & ComissÃµes
                    </h5>
                  </div>
                  <div className="pl-8 space-y-2 text-xs text-slate-600">
                    <p>
                      â€¢ <strong>Plano GrÃ¡tis (Start):</strong> R$ 0,00 de mensalidade fixa. Cadastre atÃ© 5 produtos. A comissÃ£o de 12% Ã© recolhida apÃ³s a venda realizada.
                    </p>
                    <p>
                      â€¢ <strong>Planos Pagos (Bronze, Prata, Ouro, Premium):</strong> Produtos ilimitados, taxas de comissÃ£o reduzidas (de 9% a 3%), liberaÃ§Ã£o instantÃ¢nea de dados dos clientes e prioridade nos resultados de busca.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-purple-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      Cadastro de Produtos, Fotos & VariaÃ§Ãµes
                    </h5>
                  </div>
                  <p className="text-xs text-slate-600 pl-8">
                    No Painel do Vendedor, acesse <strong>"Meus Produtos â†’ Novo Produto"</strong>. Insira fotos de alta qualidade, tÃ­tulo claro, descriÃ§Ã£o detalhada, preÃ§o original e promocional, quantidade em estoque e variaÃ§Ãµes (ex: tamanhos P, M, G ou cores).
                  </p>
                </div>

                {/* Passo 4: RecepÃ§Ã£o de Pedidos e ConfirmaÃ§Ã£o de Estoque */}
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-purple-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    <span className="w-6 h-6 rounded-full bg-purple-700 text-white font-black text-xs flex items-center justify-center shrink-0">
                      4
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      Atendimento de Pedidos & ConfirmaÃ§Ã£o de Estoque
                    </h5>
                  </div>
                  <p className="text-xs text-slate-600 pl-8">
                    Ao receber um novo pedido, verifique fisicamente a mercadoria e clique em <strong>"Confirmar Estoque & Separar"</strong> ou <strong>"Informar Esgotado"</strong>. Isso atualiza o cliente instantaneamente e evita reclamaÃ§Ãµes.
                  </p>
                </div>

                {/* Passo 5: ValidaÃ§Ã£o com CÃ³digo de Retirada */}
                <div className="p-4 rounded-2xl border border-slate-200 bg-white hover:border-purple-300 transition-all space-y-2">
                  <div className="flex items-center space-x-2">
                    <span className="w-6 h-6 rounded-full bg-purple-700 text-white font-black text-xs flex items-center justify-center shrink-0">
                      5
                    ...
                    <h5 className="font-black text-slate-900 text-sm">
                      ValidaÃ§Ã£o de SeguranÃ§a na Retirada no BalcÃ£o
                    </h5>
                  </div>
                  <p className="text-xs text-slate-600 pl-8">
                    Para pedidos com retirada presencial, solicite ao cliente o <strong>CÃ³digo de SeguranÃ§a de 6 dÃ­gitos</strong> exibido na tela dele. Digite o cÃ³digo na aba <strong>"Validar Retirada"</strong> do seu painel para dar baixa oficial e registrar a entrega com seguranÃ§a jurÃ­dica.
                  </p>
                </div>

                {/* Passo 6: Repasse de ComissÃ£o via PIX Oficial */}
                <div className="p-4 rounded-2xl border-2 border-emerald-300 bg-emerald-50/50 hover:border-emerald-400 transition-all space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <h5 className="font-black text-emerald-950 text-sm">
                        Pagamento de ComissÃ£o da Plataforma via PIX Oficial
                      </h5>
                    </div>
                  ...
                  <p className="text-xs text-slate-700 pl-8 leading-relaxed">
                    Para liberaÃ§Ã£o dos dados de contato do cliente no Plano GrÃ¡tis ou recolhimento de comissÃµes, o pagamento deve ser realizado exclusivamente para a conta oficial da plataforma:
                  </p>
                ...
                {/* Passo 7: ContrataÃ§Ã£o de Banners de Destaque */}
                <div className="p-4 rounded-2xl border border-purple-200 bg-purple-50/50 hover:border-purple-300 transition-all space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] bg-purple-200 text-purple-900 font-extrabold px-2 py-0.5 rounded-full">
                      Teto: AtÃ© {MAX_BANNER_QUANTITY} Banners
                    </span>
                  </div>
                  <div className="pl-8 space-y-2 text-xs text-slate-700">
                    <p>
                      â€¢ <strong>PreÃ§o Base:</strong> <strong>R$ {BANNER_BASE_PRICE.toFixed(2).replace('.', ',')}</strong> mensais para pacotes de <strong>atÃ© 3 banners</strong> rotativos na pÃ¡gina inicial e categorias.
                    </p>
                    <p>
                      â€¢ <strong>Banners Adicionais:</strong> <strong>+ R$ {BANNER_EXTRA_UNIT_PRICE.toFixed(2).replace('.', ',')}</strong> por banner adicional acima de 3, respeitando o <strong>limite mÃ¡ximo de {MAX_BANNER_QUANTITY} banners</strong> por estabelecimento comercial.
                    </p>
                    <p>
                      â€¢ <strong>LiberaÃ§Ã£o:</strong> Imediata apÃ³s a confirmaÃ§Ã£o do pagamento via PIX para <strong>Bex ServiÃ§os e ComÃ©rcios, CNPJ 30.810.800/0001-39</strong>.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* TAB 3: NORMAS, LGPD & TRANSPARÃŠNCIA LEGAL */}
          {activeTab === 'LEGAL' && (
            <div className="space-y-6 animate-in fade-in duration-150">
              {/* Highlight summary */}
              <div className="p-4 bg-blue-50/80 border border-blue-200 rounded-2xl text-blue-950 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div className="space-y-1">
                  <div className="flex items-center space-x-2 text-xs font-black uppercase text-blue-800 tracking-wider">
                    <Scale className="w-4 h-4 text-blue-600" />
                    <span>Conformidade RegulatÃ³ria & TransparÃªncia Municipal</span>
                  </div>
                  <h3 className="text-sm sm:text-base font-black text-slate-900">
                    Direitos Autorais, ProteÃ§Ã£o de Dados (LGPD) & CÃ³digo do Consumidor
                  </h3>
                  <p className="text-xs text-slate-600">
                    RegulamentaÃ§Ã£o jurÃ­dica completa para garantir seguranÃ§a a clientes, lojistas e parceiros.
                  </p>
                </div>
                <div className="px-3 py-1.5 bg-white border border-blue-300 rounded-xl text-[11px] font-bold text-blue-800 shrink-0">
                  LegislaÃ§Ã£o Brasileira Vigente
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white space-y-2">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    A plataforma Achei Aqui foi concebida, desenhada e desenvolvida integralmente por <strong>Bex ServiÃ§os e ComÃ©rcios, CNPJ 30.810.800/0001-39</strong>, detentora universal dos direitos morais e patrimoniais da obra sob a <strong>Lei Federal nÂº 9.610/1998 (LDA)</strong> e <strong>Lei nÂº 9.609/1998 (Software)</strong>. Ã‰ estritamente vedada a cÃ³pia, descompilaÃ§Ã£o ou reproduÃ§Ã£o sem licenÃ§a formal por escrito.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white space-y-2">
                  <div className="flex items-center space-x-2 text-slate-900 font-bold text-sm">
                    ...
                    <span>2. ProteÃ§Ã£o de Dados & Privacidade (LGPD)</span>
                  </div>
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Em conformidade com a <strong>Lei nÂº 13.709/2018 (LGPD)</strong>, os dados coletados (nome, telefone, endereÃ§o de entrega) sÃ£o tratados com criptografia e utilizados estritamente para o processamento das transaÃ§Ãµes comerciais. O usuÃ¡rio tem o direito de solicitar a consulta, retificaÃ§Ã£o ou exclusÃ£o de sua conta a qualquer momento.
                  </p>
                </div>

                {/* 3. CÃ³digo do Consumidor */}
                <div className="p-4 rounded-2xl border border-slate-200 bg-white space-y-2">
                  <div className="flex items-center space-x-2 text-slate-900 font-bold text-sm">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Aplicam-se as normas da <strong>Lei Federal nÂº 8.078/1990 (CÃ³digo de Defesa do Consumidor)</strong> e <strong>Decreto nÂº 7.962/2013 (ComÃ©rcio EletrÃ´nico)</strong>. O consumidor tem direito Ã  informaÃ§Ã£o clara de preÃ§os, garantia legal contra vÃ­cios de produtos e prazo de reflexÃ£o conforme a modalidade de venda.
                  </p>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-slate-200 bg-white space-y-2">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Regido pela <strong>Lei Federal nÂº 12.965/2014</strong>, que estabelece princÃ­pios, garantias, direitos e deveres para o uso da internet no Brasil, assegurando a inviolabilidade da intimidade e do sigilo das comunicaÃ§Ãµes privadas.
                  </p>
                </div>
              </div>

              {/* Atalhos RÃ¡pidos Legais */}
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
                <h5 className="font-black text-slate-900 text-xs uppercase tracking-wider flex items-center space-x-1.5">
                  ...
                  <span>Documentos JurÃ­dicos Integrados para Consulta:</span>
                </h5>
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                  ...
                  >
                    <span className="text-[10px] text-slate-500 font-bold uppercase block">ComissÃµes</span>
        ...
        <div className="bg-slate-50 p-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          <div className="flex items-center space-x-1.5 text-xs text-slate-600">
            ...
            <span>
              Autor e Titular Oficial: <strong>Bex ServiÃ§os e ComÃ©rcios, CNPJ 30.810.800/0001-39</strong>
            </span>
          </div>
