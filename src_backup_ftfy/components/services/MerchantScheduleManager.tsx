...
const DEFAULT_DAYS = [
  ...
  { day: 'TerÃ§a', isOpen: true, startHour: '08:00', endHour: '18:00', lunchStart: '12:00', lunchEnd: '13:00' },
  ...
  { day: 'SÃ¡bado', isOpen: true, startHour: '08:30', endHour: '13:00', lunchStart: '', lunchEnd: '' },
...
const DEFAULT_SLOTS: MerchantAvailableSlot[] = [
  ...
  { id: 's-7', dayOfWeek: 'TerÃ§a', time: '09:00', isAvailable: true, period: 'MANHA' },
  { id: 's-8', dayOfWeek: 'TerÃ§a', time: '10:30', isAvailable: true, period: 'MANHA' },
  { id: 's-9', dayOfWeek: 'TerÃ§a', time: '14:00', isAvailable: true, period: 'TARDE' },
  { id: 's-10', dayOfWeek: 'TerÃ§a', time: '16:00', isAvailable: true, period: 'TARDE' },
  ...
  { id: 's-23', dayOfWeek: 'SÃ¡bado', time: '09:00', isAvailable: true, period: 'MANHA' },
  { id: 's-24', dayOfWeek: 'SÃ¡bado', time: '10:30', isAvailable: true, period: 'MANHA' },
  { id: 's-25', dayOfWeek: 'SÃ¡bado', time: '12:00', isAvailable: true, period: 'MANHA' }
];
...
export const MerchantScheduleManager: React.FC<MerchantScheduleManagerProps> = ({
  ...
  // Pricing Table state (Hora, Dia, MÃªs)
  ...
  const [pricingNotes, setPricingNotes] = useState(
    merchant.pricingTable?.pricingNotes ||
      'Deslocamento incluso para o Centro, Papucaia e JapuÃ­ba. PeÃ§as e materiais orÃ§ados Ã  parte com total transparÃªncia.'
  );
  ...
  const [warrantyInfo, setWarrantyInfo] = useState(
    merchant.credentials?.warrantyInfo || '90 dias de garantia legal com emissÃ£o de nota fiscal de serviÃ§os.'
  );
  const [references, setReferences] = useState<ProfessionalReference[]>(
    merchant.references || [
      ...
      { name: 'CondomÃ­nio Solar Macacu', phone: '(21) 99123-4567', relationshipOrRole: 'ManutenÃ§Ã£o Predial' }
    ]
  );
  ...
  const handleAddSlot = () => {
    ...
    triggerToast(`HorÃ¡rio ${newSlotTime} adicionado para ${selectedDayFilter}!`);
  };
  ...
  const handleAddReference = () => {
    if (!newRefName || !newRefPhone) {
      alert('Preencha o nome e o telefone da referÃªncia.');
      return;
    }
    setReferences((prev) => [
      ...prev,
      {
        name: newRefName,
        phone: newRefPhone,
        relationshipOrRole: newRefRole || 'Cliente de ReferÃªncia'
      }
    ]);
    setNewRefName('');
    setNewRefPhone('');
    setNewRefRole('');
    triggerToast('ReferÃªncia adicionada!');
  };
  ...
  const handleSaveAll = () => {
    ...
    triggerToast('Agenda, Tabela de PreÃ§os e Credenciais salvas com sucesso!');
  };
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-slate-900 text-white p-5 rounded-2xl border border-slate-800 shadow-md">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center space-x-2 text-blue-400 text-xs font-bold uppercase tracking-wider mb-1">
              ...
              <span>GestÃ£o de Agenda & TransparÃªncia do Prestador</span>
            </div>
            <h3 className="text-xl sm:text-2xl font-black text-white">
              {merchant.name}
            </h3>
            <p className="text-xs text-slate-300 mt-1 max-w-2xl leading-relaxed">
              Configure os dias e horÃ¡rios livres para que os clientes agendem diretamente pelo Achei Aqui.
              Defina tambÃ©m sua tabela de preÃ§os transparente (hora, dia e mÃªs) e suas credenciais profissionais.
            </p>
          </div>
          ...
          >
            ...
            <span>Salvar Todas as ConfiguraÃ§Ãµes</span>
          </button>
        </div>
        ...
        <div className="flex items-center space-x-2 mt-5 border-t border-slate-800 pt-3 overflow-x-auto">
          ...
          >
            ...
            <span>Tabela de PreÃ§os (Hora, Dia e MÃªs)</span>
          </button>
          ...
          >
            ...
            <span>Credenciais & ReferÃªncias</span>
          </button>
        </div>
      </div>
      ...
      {activeTab === 'schedule' && (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              >
                ...
                <div className="text-xs">
                  <div className="font-bold">No Estabelecimento / ConsultÃ³rio</div>
                  <div className="text-[10px] text-slate-500 font-normal">Cliente vai atÃ© seu endereÃ§o</div>
                </div>
              </label>
              ...
              >
                ...
                />
                <div className="text-xs">
                  <div className="font-bold">Em DomicÃ­lio (MÃ³vel)</div>
              ...
              >
                ...
                <div className="text-xs">
                  ...
                  <div className="text-[10px] text-slate-500 font-normal">Videochamada, aulas e orientaÃ§Ãµes</div>
                </div>
              </label>
            </div>
          </div>

          {/* Dias e HorÃ¡rios de Funcionamento da Semana */}
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Marque os dias em que sua agenda estÃ¡ aberta e os horÃ¡rios de inÃ­cio e tÃ©rmino.
                </p>
              </div>

              <div className="flex items-center space-x-3 text-xs">
                <span className="text-slate-600">DuraÃ§Ã£o mÃ©dia da vaga:</span>
                <select
                  value={slotDuration}
                ...
                >
                  ...
                  {d.isOpen && (
                    <div className="flex items-center space-x-2 text-slate-700">
                      ...
                      />
                      <span className="text-slate-500">Ã s</span>
                      <input
                        type="time"
                        value={d.endHour}
          ...
          {/* Vagas e HorÃ¡rios DisponÃ­veis para o Cliente Agendar */}
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Clique em um horÃ¡rio para alternar entre <strong>VAGA LIVRE (Verde)</strong> e <strong>BLOQUEADO (Cinza)</strong>.
                </p>
              </div>
            ...
            <div className="space-y-3">
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="text-[10px] uppercase font-bold tracking-tight block mt-0.5">
                          {slot.isAvailable ? 'âœ“ Vaga Livre' : 'âœ• Bloqueado'}
                        </span>
                      </button>
              ...
              {customSlots.filter((s) => s.dayOfWeek === selectedDayFilter).length === 0 && (
                <div className="p-6 text-center bg-slate-50 rounded-xl border border-dashed border-slate-300 text-xs text-slate-500">
                  Nenhum horÃ¡rio cadastrado para {selectedDayFilter}. Adicione novas vagas no botÃ£o acima.
                </div>
              )}
            </div>
          </div>
      ...
      {/* TAB 2: PRICING TABLE (HORA, DIA, MÃŠS) */}
      {activeTab === 'pricing' && (
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs space-y-4">
            <div>
              <h4 className="font-bold text-sm text-slate-900 flex items-center space-x-2">
                ...
                <span>Tabela de PreÃ§os Transparente (Hora, Dia e MÃªs)</span>
              </h4>
              <p className="text-xs text-slate-500">
                Informe os valores praticados para que o cliente de Cachoeiras de Macacu tenha transparÃªncia total na contrataÃ§Ã£o.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-blue-50/60 rounded-xl border border-blue-200 space-y-2">
                ...
                <p className="text-[10px] text-blue-800 leading-relaxed">
                  CobranÃ§a por hora para consultas, aulas avulsas ou serviÃ§os rÃ¡pidos de reparo.
                </p>
              </div>

              {/* Valor do Dia / DiÃ¡ria */}
              <div className="p-4 bg-emerald-50/60 rounded-xl border border-emerald-200 space-y-2">
                <label className="block text-xs font-bold text-emerald-950 flex items-center space-x-1.5">
                  <Calendar className="w-3.5 h-3.5 text-emerald-600" />
                  <span>Valor da DiÃ¡ria / Dia (R$) *</span>
                </label>
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-xs text-slate-500 font-bold">R$</span>
                  <input
                ...
                <p className="text-[10px] text-emerald-800 leading-relaxed">
                  DiÃ¡ria completa de trabalho (atÃ© 8h). Indicado para reformas, diÃ¡rias tÃ©cnicas e eventos.
                </p>
              </div>
              ...
              <div className="p-4 bg-purple-50/60 rounded-xl border border-purple-200 space-y-2">
                <label className="block text-xs font-bold text-purple-950 flex items-center space-x-1.5">
                  ...
                  <span>Valor do MÃªs / Mensalidade (R$) *</span>
                </label>
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-xs text-slate-500 font-bold">R$</span>
                  <input
                ...
                <p className="text-[10px] text-purple-800 leading-relaxed">
                  Pacote mensal de aulas/cursos, manutenÃ§Ã£o preventiva predial recorrente ou estÃ©tica mensal.
                </p>
              </div>
            </div>

            {/* ObservaÃ§Ãµes de PrecificaÃ§Ã£o */}
            <div className="space-y-1.5 pt-2">
              <label className="block text-xs font-bold text-slate-700">
                ObservaÃ§Ãµes de CobranÃ§a & Deslocamento:
              </label>
              <textarea
                rows={3}
                value={pricingNotes}
                onChange={(e) => setPricingNotes(e.target.value)}
                placeholder="Ex: PeÃ§as e insumos cobrados Ã  parte. Atendimento gratuito no Centro, Papucaia e JapuÃ­ba..."
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs space-y-4">
            <h4 className="font-bold text-sm text-slate-900 flex items-center space-x-2">
              ...
              <span>HabilitaÃ§Ã£o & Credenciais Profissionais</span>
            </h4>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">
                  NÃºmero de Registro Profissional (CRM, CRO, CREA, OAB, CRP, etc.)
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">
                  Ã“rgÃ£o Fiscalizador / Entidade Emissora
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">
                  Anos de ExperiÃªncia Comprovada
                </label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">
                  Termo de Garantia do ServiÃ§o
                </label>
                <input
                  type="text"
                  value={warrantyInfo}
                  onChange={(e) => setWarrantyInfo(e.target.value)}
                  placeholder="Ex: 90 dias com emissÃ£o de nota fiscal"
                  className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs outline-none focus:bg-white focus:border-blue-500"
                />
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-xs space-y-4">
            <div>
              <h4 className="font-bold text-sm text-slate-900 flex items-center space-x-2">
                ...
                <span>ReferÃªncias Profissionais para TransparÃªncia</span>
              </h4>
              <p className="text-xs text-slate-500">
                ...
                >
                  <div>
                    ...
                    <div className="text-slate-500 text-[11px]">
                      {ref.relationshipOrRole} â€¢ <span className="font-sans text-emerald-700 font-semibold">{ref.phone}</span>
                    </div>
                  </div>
            ...
            <div className="p-3 bg-slate-50/80 rounded-xl border border-dashed border-slate-300 space-y-3">
              <span className="text-xs font-bold text-slate-700 block">Adicionar Nova ReferÃªncia:</span>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                ...
                <input
                  type="text"
                  placeholder="Tipo de ServiÃ§o Prestado"
                  value={newRefRole}
