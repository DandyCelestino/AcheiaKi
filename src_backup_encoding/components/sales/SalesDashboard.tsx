...
export const SalesDashboard: React.FC = () => {
  ...
  const userAgent = useMemo(() => {
    ...
    if (currentUser.role === 'VENDEDOR' || currentUser.role === 'REPRESENTANTE_COMERCIAL') {
      ...
      // Fallback seguro caso o vendedor tenha sido registrado e ainda nÃ£o sincronizado no array salesAgents
      return {
        id: currentUser.id,
  ...
  // Modal Pix oficial do sistema pÃ³s-cadastro
  ...
  // Regras de precificaÃ§Ã£o conforme o organograma oficial
  ...
  // PreÃ§o cobrado conforme o tipo de cadastro
  ...
  // ComissÃ£o do vendedor: exatamente 5% do valor total do plano vendido
  ...
  const handleCopy = (text: string, id: string) => {
    ...
    setCopiedId(id);
    triggerToast('CÃ³digo copiado com sucesso!');
    ...
    if (!isUserRegistration && selectedPlanPrice > 0) {
      ...
      setPixModalData({
        ...
        planTitle: isProviderRegistration
          ? 'Prestador de ServiÃ§os (Fixo R$ 29,90 - 1 serviÃ§o incluso)'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">ForÃ§a Comercial & Vendas Externas</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-5 border-t border-white/10">
            <div className="bg-white/5 p-3 rounded-xl border border-white/10">
              ...
              <span className="text-[10px] text-slate-300">
                Meta do mÃªs: {agent.monthlyTargetCount}
              </span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        <div className="flex items-center space-x-2 border-b border-slate-200 bg-white p-2 rounded-xl shadow-xs overflow-x-auto">
          ...
          >
            ...
            <span>VisÃ£o Geral & GrÃ¡ficos</span>
          </button>
          ...
          >
            ...
            <span>Meus Boletos & ComissÃµes ({myBoletos.length})</span>
          </button>
          ...
          >
            ...
            <span>Metas LanÃ§adas pelo Master ({commercialGoals.length})</span>
          </button>
        ...
        {/* ========================================================================= */}
        {/* SUBTAB 1: VISÃƒO GERAL & GRÃFICOS */}
        {/* ========================================================================= */}
        {activeTab === 'overview' && (
          <div className="space-y-6 mt-6">
            {/* GRÃFICOS ESTATÃSTICOS DE VENDAS */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* GRÃFICO 1: EVOLUÃ‡ÃƒO DE CADASTROS & VENDAS */}
              <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-xs border border-slate-200">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="font-extrabold text-sm text-slate-900 flex items-center gap-2">
                      <TrendingUp className="w-4 h-4 text-blue-600" />
                      EvoluÃ§Ã£o de Cadastros e Vendas Mensais
                    </h3>
                    <p className="text-xs text-slate-500">
                      Total de novos clientes e lojistas credenciados por vocÃª
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between mt-3 text-xs text-slate-500">
                  <span>MÃ©dia de 12 cadastros/mÃªs</span>
                  <span className="font-bold text-blue-600">Total acumulado: R$ 4.660,00</span>
                </div>
              </div>

              {/* GRÃFICO 2: DISTRIBUIÃ‡ÃƒO DE PLANOS */}
              <div className="bg-white p-6 rounded-2xl shadow-xs border border-slate-200 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mb-4">
                    ProporÃ§Ã£o por categoria de adesÃ£o
                  </p>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 bg-amber-50/50 p-3 rounded-xl border border-amber-200/60 text-xs">
                  ...
                  <p className="text-slate-600 text-[11px] mt-0.5">
                    O Plano Prata Ã© o campeÃ£o de vendas em Cachoeiras de Macacu por incluir destaque no Provador VIP.
                  </p>
                </div>
              </div>
            </div>

            {/* MEUS ÃšLTIMOS CLIENTES CADASTRADOS */}
            <div className="bg-white p-6 rounded-2xl shadow-xs border border-slate-200">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-extrabold text-sm text-slate-900 flex items-center gap-2">
                  <Store className="w-4 h-4 text-purple-600" />
                  Ãšltimos Clientes Cadastrados por VocÃª
                </h3>
                <button
                  onClick={() => setActiveTab('new-client')}
              ...
              {myClients.length === 0 ? (
                <div className="text-center py-8 text-slate-400 text-xs">
                  VocÃª ainda nÃ£o cadastrou nenhum cliente. Clique na aba acima para iniciar seu primeiro cadastro!
                </div>
              ) : (
          ...
          <div className="space-y-6 mt-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wider bg-blue-500/20 text-blue-300 border border-blue-400/30">
                      Estrutura Oficial de Vendas & ComissÃµes
                    </span>
                  ...
                  <p className="text-xs sm:text-sm text-blue-200 mt-1 max-w-2xl">
                    Entenda o fluxo completo de credenciamento, cobranÃ§a via PIX oficial (CNPJ 30.810.800/0001-39) e as regras especÃ­ficas para cada categoria cadastrada.
                  </p>
                </div>
            ...
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs space-y-8">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                {/* NÃVEL 2: VENDEDOR / CONSULTOR COMERCIAL */}
                <div className="w-full max-w-md bg-linear-to-r from-blue-600 to-indigo-600 text-white p-4 rounded-2xl shadow-md border-2 border-blue-300">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    ...
                    <h4 className="font-black text-sm uppercase tracking-wide">
                      Vendedor Comercial (VocÃª: {agent.name})
                    </h4>
                  </div>
                  ...
                  <div className="mt-2.5 inline-flex items-center gap-1.5 px-3 py-1 bg-amber-400 text-slate-950 font-black text-xs rounded-lg shadow-xs">
                    ...
                    <span>COMISSÃƒO OFICIAL: 5% DO VALOR TOTAL DO PLANO VENDIDO</span>
                  </div>
                </div>
              ...
              {/* NÃVEL 3: OS 3 TIPOS DE CADASTRO */}
              <div>
                <h4 className="text-xs font-black uppercase text-slate-400 tracking-wider text-center mb-4">
                  Os TrÃªs Ramos Oficiais de Cadastro & Suas Regras
                </h4>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  {/* CARD 1: CLIENTE / USUÃRIO COMUM */}
                  <div className="bg-emerald-50/60 border-2 border-emerald-300 rounded-2xl p-5 flex flex-col justify-between space-y-4">
                    <div className="space-y-3">
                      ...
                      <div className="bg-white p-3 rounded-xl border border-emerald-200 space-y-1.5 text-xs">
                        ...
                        <div className="flex items-center justify-between">
                          <span className="text-slate-600 font-medium">ComissÃ£o Vendedor:</span>
                      ...
                      <div className="space-y-1 text-[11px] text-emerald-900 font-medium bg-emerald-100/50 p-3 rounded-xl">
                        ...
                        <p>â€¢ Comprar produtos no Marketplace</p>
                        <p>â€¢ Solicitar orÃ§amentos e agendamentos</p>
                        <p>â€¢ Visualizar lojas e provador virtual</p>
                      </div>
                      ...
                      <div className="p-3 bg-red-50 border border-red-200 rounded-xl text-[11px] text-red-900">
                        <p className="font-black text-red-950 flex items-center gap-1 mb-1">
                          ...
                          RestriÃ§Ã£o Comercial Estrita:
                        </p>
                        <p>
                          NÃ£o tem direito de postar nenhum produto, nÃ£o pode cadastrar serviÃ§os, nÃ£o pode inserir banners e nÃ£o pode interagir no app de forma comercial.
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      Cadastrar UsuÃ¡rio GrÃ¡tis
                    </button>
                  </div>

                  {/* CARD 2: PRESTADOR DE SERVIÃ‡OS */}
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-amber-900 font-semibold mt-0.5">
                          Eletricistas, encanadores, mecÃ¢nicos, diaristas...
                        </p>
                      </div>
                      ...
                      <div className="bg-white p-3 rounded-xl border border-amber-300 space-y-1.5 text-xs">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-black text-amber-800 text-sm">R$ 29,90/mÃªs</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-slate-600 font-medium">ServiÃ§o Incluso:</span>
                          <span className="font-bold text-slate-800">1 serviÃ§o ativo</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-slate-600 font-medium">ServiÃ§o Adicional:</span>
                          <span className="font-bold text-amber-900">+ R$ 9,90/mÃªs cada</span>
                        </div>
                        <div className="flex items-center justify-between pt-1 border-t border-slate-100">
                          <span className="text-slate-700 font-bold">ComissÃ£o Vendedor (5%):</span>
                      ...
                      <div className="space-y-1 text-[11px] text-amber-950 font-medium bg-amber-100/50 p-3 rounded-xl">
                        ...
                        <p>â€¢ Sujeito Ã s regras comerciais da plataforma</p>
                        <p>â€¢ Pode postar um Ãºnico serviÃ§o no plano base</p>
                        <p>â€¢ A partir disso, serÃ¡ cobrado R$ 9,90 alÃ©m para cada serviÃ§o adicional</p>
                        <p>â€¢ CobranÃ§a via Pix oficial do app (CNPJ 30810800000139)</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-900 font-semibold mt-0.5">
                          Lojas de roupas, calÃ§ados, autopeÃ§as, Ã³ticas...
                        </p>
                      </div>
                      ...
                      <div className="bg-white p-3 rounded-xl border border-blue-200 space-y-1.5 text-xs">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-bold text-slate-800">R$ 19,90 (ComissÃ£o: R$ 1,00)</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-slate-600 font-medium">Plano Ouro:</span>
                          <span className="font-bold text-slate-800">R$ 49,90 (ComissÃ£o: R$ 2,50)</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-slate-600 font-medium">Plano Prata:</span>
                          <span className="font-bold text-slate-800">R$ 59,90 (ComissÃ£o: R$ 3,00)</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-slate-600 font-medium">Plano Premium:</span>
                          <span className="font-bold text-slate-800">R$ 199,90 (ComissÃ£o: R$ 10,00)</span>
                        </div>
                        <div className="flex items-center justify-between pt-1 border-t border-slate-100">
                          <span className="text-slate-700 font-bold">ComissÃ£o Vendedor:</span>
                      ...
                      <div className="space-y-1 text-[11px] text-blue-950 font-medium bg-blue-100/50 p-3 rounded-xl">
                        ...
                        <p>â€¢ Vendedor finaliza o cadastro e gera QR Code</p>
                        <p>â€¢ Pix gerado com CNPJ 30810800000139</p>
                        <p>â€¢ SinalizaÃ§Ã£o em tempo real da comissÃ£o de 5%</p>
                      </div>
                    </div>
              ...
              <div className="border-b border-slate-100 pb-4">
                <div className="flex items-center justify-between mb-1">
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase bg-blue-100 text-blue-800 tracking-wider">
                    Organograma Oficial â€¢ Bex ServiÃ§os e ComÃ©rcios
                  </span>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Preencha os dados abaixo. Para Prestador ou Lojista, o sistema gera o QR Code Pix oficial na hora e sinaliza sua comissÃ£o de 5%.
                </p>
              </div>

              <form onSubmit={handleRegisterClientSubmit} className="space-y-5 text-xs">
                {/* 1. SELEÃ‡ÃƒO DO TIPO DE CADASTRO CONFORME O ORGANOGRAMA */}
                <div>
                  <label className="font-bold text-slate-800 block mb-2 text-xs">
                    Selecione a Categoria no Organograma Comercial:
                  </label>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {/* OPÃ‡ÃƒO 1: USUÃRIO COMUM */}
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <span className="text-[11px] text-slate-600 block leading-tight">
                        Sem mensalidades. Somente compras no app. NÃ£o pode postar produtos nem banners.
                      </span>
                    </button>

                    {/* OPÃ‡ÃƒO 2: PRESTADOR DE SERVIÃ‡OS */}
                    <button
                      type="button"
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className="font-black text-xs block">Prestador ServiÃ§os</span>
                        <span className="text-[9px] font-black uppercase px-2 py-0.5 rounded-md bg-amber-200 text-amber-950">
                          Fixo R$ 29,90
                        </span>
                      </div>
                      <span className="text-[11px] text-slate-600 block leading-tight">
                        1 serviÃ§o incluso. Extra: +R$ 9,90 cada. Pix oficial CNPJ. ComissÃ£o 5% (R$ 1,50).
                      </span>
                    </button>

                    {/* OPÃ‡ÃƒO 3: LOJISTA COMERCIAL */}
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <span className="text-[11px] text-slate-600 block leading-tight">
                        ComÃ©rcio fÃ­sico. Escolhe o plano mensal. Pix oficial CNPJ. ComissÃ£o 5% do plano.
                      </span>
                    </button>
                  </div>
                </div>

                {/* BANNER DINÃ‚MICO DE REGRAS EXPLICATIVAS */}
                {isUserRegistration && (
                  <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-2xl flex items-start gap-3">
                    <ShieldCheck className="w-5 h-5 text-emerald-600 shrink-0 mt-0.5" />
                    <div className="space-y-1">
                      <p className="font-bold text-emerald-950 text-xs">
                        Regra de Cadastro de UsuÃ¡rio / Consumidor:
                      </p>
                      <p className="text-[11px] text-emerald-800 leading-relaxed">
                        O cadastro de usuÃ¡rio Ã© <strong>100% gratuito (R$ 0,00)</strong> e nÃ£o possui mensalidades. 
                        O usuÃ¡rio tem acesso liberado para fazer compras, pedidos e agendamentos no app. 
                        <strong>AtenÃ§Ã£o:</strong> Clientes compradores nÃ£o tÃªm direito de postar nenhum produto, 
                  ...
                  <div className="p-4 bg-amber-50 border border-amber-300 rounded-2xl flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      <p className="font-bold text-amber-950 text-xs">
                        Regra de Cadastro de Prestador de ServiÃ§os:
                      </p>
                      <p className="text-[11px] text-amber-900 leading-relaxed">
                        O prestador de serviÃ§os paga o valor <strong>fixo de R$ 29,90</strong>. Ele estarÃ¡ sujeito Ã s regras jÃ¡ determinadas, 
                        podendo postar <strong>um Ãºnico serviÃ§o</strong>. A partir disso, serÃ¡ cobrado <strong>R$ 9,90 alÃ©m para cada serviÃ§o adicional</strong>. 
                        O pagamento Ã© via Pix oficial do app (CNPJ 30810800000139) e vocÃª, vendedor, recebe <strong>5% de comissÃ£o (R$ 1,50)</strong>.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-2xl flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px] text-blue-900 leading-relaxed">
                        O lojista escolhe o plano de acordo com o tamanho do catÃ¡logo. Ao finalizar, o sistema gera o QR Code Pix oficial do app 
                        (Chave CNPJ 30810800000139 - Bex ServiÃ§os e ComÃ©rcios) sinalizando imediatamente para o vendedor a 
                        <strong> comissÃ£o de 5% do valor total do plano vendido</strong>.
                      </p>
                    </div>
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      placeholder={isUserRegistration ? 'Ex: Carlos Oliveira' : 'Ex: Auto PeÃ§as Macacu'}
                      value={tradeName}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Ex: Centro, Papucaia, CastÃ¡lia, JapuÃ­ba..."
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg"
                    />
                  </div>
                      ...
                      {[
                        {
                          ...
                          name: 'Plano Bronze',
                          price: 19.90,
                          desc: 'CatÃ¡logo bÃ¡sico + WhatsApp',
                          comm: 'R$ 1,00'
                        },
                        {
                          tier: 'OURO' as const,
                ...
                {/* 4. SINALIZAÃ‡ÃƒO DE VALOR E COMISSÃƒO DO VENDEDOR */}
                {!isUserRegistration && (
                  <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-3">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div>
                        ...
                        <span className="text-2xl font-black text-slate-950 mt-0.5 block">
                          ...
                          <span className="text-xs font-normal text-slate-500"> /mÃªs</span>
                        </span>
                        <span className="text-[11px] text-slate-500">
                          {isProviderRegistration 
                            ? 'Inclui 1 serviÃ§o. ServiÃ§os adicionais: R$ 9,90 cada'
                    ...
                    <div className="pt-2 border-t border-slate-200 text-[11px] text-slate-600 flex items-center gap-1.5">
                      ...
                      <span>
                        Ao clicar no botÃ£o abaixo, o <strong>QR Code Pix</strong> com o CNPJ <strong>30810800000139</strong> serÃ¡ gerado na hora para o cliente pagar.
                      </span>
                    </div>
                  </div>
                )}
        ...
        {/* ========================================================================= */}
        {/* SUBTAB 3: MEUS BOLETOS & COMISSÃ•ES */}
        {/* ========================================================================= */}
        {activeTab === 'my-boletos' && (
          <div className="space-y-4 mt-6">
            <div className="bg-white p-4 rounded-xl shadow-xs border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex-1 relative">
                ...
                <input
                  type="text"
                  placeholder="Buscar boleto por cliente, cÃ³digo ou documento..."
                  value={searchTerm}
              ...
              {myBoletos.length === 0 ? (
                <div className="bg-white p-12 text-center rounded-2xl border border-slate-200">
                  ...
                  <h3 className="font-bold text-sm text-slate-800">
                    Nenhuma solicitaÃ§Ã£o de boleto ativa
                  </h3>
                  <p className="text-xs text-slate-500 mt-1">
                    Cadastre um novo lojista ou cliente para iniciar a emissÃ£o de boletos.
                  </p>
                </div>
              ) : (
                myBoletos
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                        <div className="flex items-center space-x-2">
                          ...
                          >
                            {bol.status === 'PENDENTE_EMISSAO'
                              ? 'â³ Aguardando Envio pelo Master'
                              : bol.status === 'BOLETO_ENVIADO'
                              ? 'ðŸ“¬ Boleto Enviado ao Cliente'
                              : bol.status === 'PAGAMENTO_CONFIRMADO'
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 bg-slate-50 p-3.5 rounded-xl border border-slate-100 text-xs">
                        <div>
                          ...
                          <span className="text-[11px] text-slate-500 block">
                            {bol.clientPhone} â€¢ {bol.neighborhood}
                          </span>
                        </div>
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                            <div className="min-w-0">
                              <span className="text-[10px] font-bold text-blue-900 block">
                                Linha DigitÃ¡vel do Boleto para Envio ao Cliente:
                              </span>
                            ...
                            >
                              ...
                              <span>{copiedId === bol.id ? 'Copiado!' : 'Copiar CÃ³digo'}</span>
                            </button>
                          </div>
                      ...
                      {bol.commissionStatus === 'PAGA' && bol.commissionPaymentReceipt && (
                        <div className="bg-emerald-50 p-2.5 rounded-xl border border-emerald-200 text-xs flex items-center justify-between text-emerald-900">
                          <span className="flex items-center gap-1.5 font-bold">
                            ...
                            ComissÃ£o de R$ {bol.commissionAmount.toFixed(2)} repassada via Pix pelo
                            Master!
                          </span>
        ...
        {/* ========================================================================= */}
        {/* SUBTAB 4: METAS LANÃ‡ADAS PELO MASTER */}
        {/* ========================================================================= */}
        {activeTab === 'my-goals' && (
          <div className="space-y-4 mt-6">
            <div className="bg-white p-6 rounded-2xl shadow-xs border border-slate-200">
              <h3 className="font-black text-base text-slate-900 flex items-center gap-2">
                ...
                Campanhas & Metas LanÃ§adas pelo Administrador Master
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">
                Bata as metas mensais para receber premiaÃ§Ãµes adicionais no Pix alÃ©m da sua comissÃ£o contratual padrÃ£o.
              </p>
            </div>
                    ...
                    <div className="bg-amber-50/80 p-3 rounded-xl border border-amber-200 text-xs flex items-center space-x-3">
                      ...
                      <div>
                        <span className="text-[10px] uppercase font-bold text-amber-800 block">
                          BÃ´nus / PremiaÃ§Ã£o Especial do Master
                        </span>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xs border border-slate-200 mt-6 space-y-6">
            <div>
              <h3 className="font-black text-base text-slate-900 flex items-center gap-2">
                ...
                Estrutura & PosiÃ§Ã£o na ForÃ§a Comercial
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">
                VocÃª faz parte da equipe comercial oficial do Achei Aqui em Cachoeiras de Macacu.
              </p>
            </div>
          ...
          <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl border border-slate-200 overflow-hidden my-6">
            ...
            <div className="bg-linear-to-r from-blue-700 via-blue-800 to-indigo-900 text-white p-6 relative">
              ...
              <p className="text-xs text-blue-100 mt-1">
                Apresente o QR Code ao cliente ou envie o cÃ³digo Copia e Cola no WhatsApp para pagamento imediato.
              </p>
            </div>

            {/* BODY */}
            <div className="p-6 space-y-5">
              {/* CARD DE DADOS DA TRANSAÃ‡ÃƒO */}
                ...
                <div className="flex justify-between items-center bg-emerald-50 p-2.5 rounded-xl border border-emerald-200">
                  <div>
                    <span className="text-[10px] uppercase font-black text-emerald-900 block">
                      Sua ComissÃ£o (5% do Valor Total):
                    </span>
              ...
              <div className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-2xl border-2 border-dashed border-slate-300">
                ...
                <span className="text-[11px] font-bold text-slate-700 mt-2">
                  BeneficiÃ¡rio Oficial: {pixModalData.beneficiary}
                </span>
              ...
              {pixModalData.phone && (
                <a
                  href={`https://wa.me/55${pixModalData.phone.replace(/\D/g, '')}?text=${encodeURIComponent(
                    `OlÃ¡ ${pixModalData.clientName}! Segue o cÃ³digo Pix para ativaÃ§Ã£o da sua conta no Achei Aqui:\n\n*Valor:* R$ ${pixModalData.amount.toFixed(2)}\n*BeneficiÃ¡rio:* ${pixModalData.beneficiary}\n*Chave CNPJ:* 30810800000139\n\n*Pix Copia e Cola:*\n${pixModalData.pixCopiaECola}`
                  )}`}
                  target="_blank"
                ...
                >
                  ...
                  <span>Enviar CÃ³digo Pix no WhatsApp do Cliente</span>
                </a>
              )}
            </div>
            ...
            <div className="p-4 bg-slate-100 border-t border-slate-200 flex items-center justify-end">
              ...
              >
                Concluir e Ver Meus Boletos / CobranÃ§as
              </button>
            </div>
          </div>
        </div>
