...
export const MasterSettingsView: React.FC = () => {
  ...
  const handleConfirmReset = () => {
    if (resetConfirmWord !== 'RESTAURAR') {
      triggerToast('Palavra de confirmaÃ§Ã£o incorreta.');
      return;
    }
    resetDatabaseToDefaults();
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900 leading-tight">
                ParÃ¢metros Globais, PolÃ­ticas & Backup
              </h2>
              <p className="text-xs text-slate-500">
                Ajuste os parÃ¢metros centrais da plataforma, taxas municipais, avisos de emergÃªncia e gestÃ£o de snapshots.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* FormulÃ¡rio de ParÃ¢metros Principais */}
        <div className="lg:col-span-2 space-y-6">
          <form onSubmit={handleSaveSettings} className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-6 text-xs">
            <h3 className="font-bold text-slate-900 text-sm border-b border-slate-100 pb-3 flex items-center space-x-2">
              ...
              <span>Regras de NegÃ³cio & PolÃ­ticas do Marketplace</span>
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <span className="text-[10px] text-slate-400 block mt-1">
                  Valor sugerido para corridas dentro do perÃ­metro urbano.
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block font-bold text-slate-700 mb-1">
                  Prazo de DevoluÃ§Ã£o Provador VIP (Dias)
                </label>
                <input
                  type="number"
                  min="1"
                ...
                />
                <span className="text-[10px] text-slate-400 block mt-1">
                  Tempo mÃ¡ximo que o cliente pode reter a malinha de roupas em casa.
                </span>
              </div>
            ...
            <div className="space-y-3 pt-3 border-t border-slate-100">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="font-bold text-slate-800 block">Auto-AprovaÃ§Ã£o de Lojistas</span>
                  <span className="text-[11px] text-slate-500">
                    Se ativado, novas lojas entram no catÃ¡logo instantaneamente sem aprovaÃ§Ã£o manual.
                  </span>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="font-bold text-slate-800 block">Cadastro PÃºblico de Clientes</span>
                  <span className="text-[11px] text-slate-500">
                    Permite que novos munÃ­cipes criem conta livremente no marketplace.
                  </span>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="font-bold text-slate-800 block">BalÃ£o Flutuante de NotificaÃ§Ãµes (Floating Ball)</span>
                  <span className="text-[11px] text-slate-500">
                    Exibe balÃµes flutuantes fixos na tela para usuÃ¡rios logados com notificaÃ§Ãµes pendentes, mantendo-os visÃ­veis atÃ© que o usuÃ¡rio clique em 'X'.
                  </span>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="p-3 bg-amber-50/60 rounded-xl border border-amber-200 flex items-center justify-between">
                <div>
                  <span className="font-bold text-amber-900 block">Modo ManutenÃ§Ã£o Geral</span>
                  <span className="text-[11px] text-amber-700">
                    Suspende a realizaÃ§Ã£o de novos pedidos temporariamente.
                  </span>
                </div>
                <input
                  type="checkbox"
            ...
            {/* Alerta de TransmissÃ£o Global */}
            <div className="pt-3 border-t border-slate-100 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <span className="font-bold text-slate-800 block">
                    Alerta de TransmissÃ£o na Home (Banner)
                  </span>
                  <span className="text-[11px] text-slate-500">
              ...
              {formData.broadcastAlertEnabled && (
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ex: Feriado municipal: lojas do centro funcionando atÃ© Ã s 14h."
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-blue-500"
                  />
                </div>
              )}
        ...
        {/* Central de Snapshots & RecuperaÃ§Ã£o de Desastres */}
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-4 text-xs">
            ...
            <p className="text-slate-500 leading-relaxed">
              Exporte uma cÃ³pia completa de todos os dados do ecossistema (UsuÃ¡rios, Lojas, CatÃ¡logo, Pedidos, Auditoria) para armazenamento local e seguranÃ§a.
            </p>
          ...
          <div className="bg-rose-50/50 p-6 rounded-2xl border border-rose-200 shadow-xs space-y-4 text-xs">
            ...
            <p className="text-rose-700 leading-relaxed">
              Restaura a base de dados original limpa com as lojas e usuÃ¡rios padrÃ£o de demonstraÃ§Ã£o. Use com cautela.
            </p>
            ...
            >
              ...
              <span>Resetar Banco para PadrÃ£o</span>
            </button>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-xl rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={handleImportSubmit} className="p-6 overflow-y-auto space-y-4 text-xs">
              ...
              <div>
                <label className="block font-bold text-slate-700 mb-1">
                  Ou Cole o ConteÃºdo do Backup (JSON):
                </label>
                <textarea
                  rows={8}
                  required
      ...
      {/* MODAL: CONFIRMAÃ‡ÃƒO DE RESET DE FÃBRICA */}
      {showResetModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden p-6 space-y-4 text-xs">
            <div className="flex items-center space-x-3 text-rose-600">
              ...
              <div>
                <h3 className="font-bold text-slate-900 text-sm">
                  Restaurar Banco para PadrÃ£o Inicial
                </h3>
                <p className="text-[11px] text-slate-500">
                  Esta aÃ§Ã£o substituirÃ¡ todos os dados pelos registros padrÃ£o de Cachoeiras de Macacu.
                </p>
              </div>
            </div>
