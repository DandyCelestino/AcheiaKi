...
export const MasterOrdersView: React.FC<MasterOrdersViewProps> = ({ onOpenDossier }) => {
  ...
  const handleCreateOrderSubmit = (e: React.FormEvent) => {
    ...
    if (!newOrderForm.customerName || !newOrderForm.merchantId) {
      triggerToast('Preencha os campos obrigatÃ³rios.');
      return;
    }
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Controle operacional de todas as transaÃ§Ãµes, rotas de entrega e intervenÃ§Ã£o emergencial Master.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row items-center gap-3">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            placeholder="Buscar por cÃ³digo (DEL-..., RET-...), cliente, loja, endereÃ§o..."
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto">
          ...
          >
            ...
            <option value="RETIRADA">Retirada BalcÃ£o</option>
            <option value="EXPERIMENTAÃ‡ÃƒO">Provador VIP</option>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-50/80 text-slate-600 font-semibold uppercase text-[10px] tracking-wider border-b border-slate-200/80">
              <tr>
                <th className="px-4 py-3.5">CÃ³digo & Modalidade</th>
                ...
                <th className="px-4 py-3.5 text-right">IntervenÃ§Ã£o Master</th>
              </tr>
            </thead>
                ...
                <tr key={ord.id} className="hover:bg-slate-50/60 transition-colors">
                  ...
                  <td className="px-4 py-3.5">
                    <button
                      ...
                      title="Clique para abrir DossiÃª do Cliente"
                    >
                  ...
                  <td className="px-4 py-3.5">
                    <button
                      ...
                      className="text-left group cursor-pointer"
                      title="Clique para abrir DossiÃª do Estabelecimento"
                    >
                  ...
                  <td className="px-4 py-3.5 text-right">
                    <div className="flex items-center justify-end space-x-1">
                      ...
                      <button
                        ...
                        title="Disparar NotificaÃ§Ã£o WhatsApp"
                        className="p-1.5 text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors"
                      >
                        <MessageSquare className="w-3.5 h-3.5" />
                      </button>

                      {/* Concluir Manualmente / Baixa ForÃ§ada */}
                      {ord.status !== 'ConcluÃ­do' && ord.status !== 'Cancelado' && (
                        <button
                          onClick={() => forceCompleteOrderByMaster(ord.id)}
                          title="ForÃ§ar Baixa / Concluir Pedido"
                      ...
                      <button
                        ...
                        title="Editar InformaÃ§Ãµes do Pedido"
          ...
          <div className="bg-white w-full max-w-xl rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
            <div className="p-4 border-b border-slate-200 flex items-center justify-between bg-slate-50">
              <div>
                ...
                <p className="text-[11px] text-slate-500">
                  {viewingOrder.merchantName} â€¢ {viewingOrder.modality}
                </p>
              </div>
              <button
            ...
            <div className="p-6 overflow-y-auto space-y-4 text-xs text-slate-700">
              ...
              {viewingOrder.deliveryAddress && (
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                  <span className="text-slate-400 block text-[10px]">EndereÃ§o de Entrega</span>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-xl rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={handleSaveEdit} className="p-6 overflow-y-auto space-y-4 text-xs">
              ...
              <div>
                <label className="block font-bold text-slate-700 mb-1">EndereÃ§o de Entrega</label>
                <input
                  type="text"
          ...
          <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden p-6 space-y-4 text-xs">
            <div className="flex items-center space-x-3 text-rose-600">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500">
                  Esta aÃ§Ã£o altera o status para Cancelado e notifica o cliente.
                </p>
              </div>
            </div>
      ...
      {showNewOrderModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-xl rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
            <div className="p-4 border-b border-slate-200 flex items-center justify-between bg-slate-50">
              <h3 className="font-bold text-slate-900 text-sm">
                Inserir Pedido Manual de EmergÃªncia
              </h3>
              <button
            ...
            <form onSubmit={handleCreateOrderSubmit} className="p-6 overflow-y-auto space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  >
                    <option value="DELIVERY">DELIVERY</option>
                    <option value="RETIRADA">RETIRADA BALCÃƒO</option>
                    <option value="EXPERIMENTAÃ‡ÃƒO">PROVADOR VIP</option>
                    <option value="AGENDAMENTO">AGENDAMENTO</option>
                  </select>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: 2x Pizza MÃ©dia Calabresa"
                  className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-blue-500"
                />
              </div>
