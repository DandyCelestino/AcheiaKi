...
export const MasterSellerCommissionsView: React.FC = () => {
    ...
    return (
      <div className="p-8 text-center bg-white rounded-2xl border border-rose-200 shadow-sm max-w-xl mx-auto my-12">
        ...
        <p className="text-xs text-slate-600 mt-2 leading-relaxed">
          Apenas o usuÃ¡rio com perfil <strong>MASTER</strong> possui autorizaÃ§Ã£o para consultar, estipular e alterar os valores de comissÃ£o de cada vendedor e consultor comercial do sistema.
        </p>
      </div>
    );
  }
  ...
  const handleApplyMassRate = () => {
    ...
    addAuditLog(
      ...
      `Master Supremo aplicou comissÃ£o padrÃ£o de ${massRate}% (bÃ´nus R$ ${massBonus}) para todos os ${salesAgents.length} vendedores da equipe.`,
      { category: 'FINANCIAL' }
    );
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight">
              GestÃ£o Individual de ComissÃµes dos Vendedores
            </h1>
            <p className="text-xs sm:text-sm text-slate-400 max-w-2xl leading-relaxed">
              Como Administrador Master Supremo, determine a porcentagem exata de comissÃ£o e bÃ´nus que cada consultor ou vendedor recebe ao cadastrar novos lojistas e prestadores de serviÃ§os.
            </p>
          </div>
          ...
          <div className="bg-slate-800/80 border border-slate-700/70 p-4 rounded-2xl shrink-0 space-y-2 text-xs">
            ...
            <ul className="space-y-1 text-slate-400 text-[11px]">
              <li>â€¢ <strong>UsuÃ¡rio Comprador:</strong> R$ 0,00 (GrÃ¡tis, sem comissÃ£o)</li>
              <li>â€¢ <strong>Prestador de ServiÃ§os:</strong> R$ 29,90 fixo</li>
              <li>â€¢ <strong>Lojista Comercial:</strong> Conforme o plano escolhido</li>
              <li>â€¢ <strong>Chave Pix Central do App:</strong> 30810800000139 (Bex ServiÃ§os)</li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-5 border-t border-slate-800">
          ...
          <div className="bg-slate-950/60 p-3.5 rounded-2xl border border-slate-800/80">
            ...
            <div className="flex items-baseline space-x-2 mt-1 truncate">
              <span className="text-xs font-bold text-white truncate">Bex ServiÃ§os</span>
            </div>
      ...
      {/* 2. BARRA DE AJUSTE EM MASSA (OPÃ‡ÃƒO RÃPIDA MASTER) */}
      <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-500">
            Aplica uma porcentagem uniforme de comissÃ£o instantaneamente para todos os vendedores cadastrados.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          ...
          <div className="flex items-center space-x-2 bg-slate-50 border border-slate-200 rounded-xl px-3 py-1.5">
            <span className="text-xs font-bold text-slate-700">BÃ´nus (R$):</span>
            <input
              type="number"
              min={0}
              value={massBonus}
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white p-3 rounded-2xl border border-slate-200 shadow-xs">
        <div className="relative w-full sm:w-80">
          ...
          <input
            type="text"
            placeholder="Buscar por nome, email, CPF ou regiÃ£o..."
            value={searchTerm}
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
          <span className="text-xs font-bold text-slate-500 whitespace-nowrap">RegiÃ£o:</span>
          <select
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-500 mt-1">
                      ...
                      <span>RegiÃ£o: <strong>{agent.assignedRegion}</strong></span>
                    </div>
                ...
                <div className="md:col-span-5 bg-slate-50 p-3 rounded-xl border border-slate-200 space-y-1.5">
                  <div className="flex items-center justify-between text-[11px] font-bold text-slate-700">
                    <span className="flex items-center space-x-1">
                      ...
                      <span>SimulaÃ§Ã£o de Ganhos com Taxa de {draft.rate}%:</span>
                    </span>
                    <span className="text-[10px] text-slate-500">CÃ¡lculo Oficial</span>
                  </div>
