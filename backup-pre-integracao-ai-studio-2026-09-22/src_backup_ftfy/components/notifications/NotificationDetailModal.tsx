...
export const NotificationDetailModal: React.FC<NotificationDetailModalProps> = ({
    ...
    switch (cat) {
      ...
      case 'COMISSAO':
        return {
          ...
          label: 'Planos & Comiss̵es'
        };
      case 'SEGURANCA':
        return {
          icon: ShieldAlert,
          color: 'text-purple-700 bg-purple-50 border-purple-200',
          label: 'Seguran̤a & Conta'
        };
      case 'URGENTE':
        return {
          icon: AlertTriangle,
  ...
  const getAudienceLabel = () => {
    switch (notification.audience) {
      case 'ALL':
        return { text: 'Transmitido para Todos (P̼blico Geral)', isPrivate: false };
      case 'ALL_MERCHANTS':
      ...
      case 'SPECIFIC_USER':
        return { text: `Mensagem Particular e Privada para ${notification.recipientName || 'Voc̻'}`, isPrivate: true };
      default:
        return { text: 'Notifica̤̣o do Sistema', isPrivate: false };
    }
  };
      ...
      >
        ...
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-4 text-slate-700 text-sm leading-relaxed">
          ...
          <div className="text-[11px] text-slate-400 flex items-center justify-between border-t border-slate-100 pt-3">
            <span className="flex items-center space-x-1 text-emerald-700 font-medium">
              ...
              <span>Notifica̤̣o entregue via Internet do App Achei Aqui</span>
            </span>
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-100 flex flex-wrap items-center justify-end gap-2">
          ...
          {notification.actionUrl && (
            ...
            >
              <span>{notification.actionLabel || 'Acessar Se̤̣o'}</span>
