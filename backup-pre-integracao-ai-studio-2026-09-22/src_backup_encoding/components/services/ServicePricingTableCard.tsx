...
export const ServicePricingTableCard: React.FC<ServicePricingTableCardProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Tabela de PreÃ§os Transparente: Hora, Dia e MÃªs */}
      <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-xs">
        <div className="bg-slate-900 text-white px-4 py-3 sm:px-5 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <h4 className="font-bold text-xs sm:text-sm tracking-wide uppercase">
              Tabela de PreÃ§os & Modalidades de ContrataÃ§Ã£o
            </h4>
          </div>
        ...
        <div className="p-4 sm:p-5 space-y-4">
          <p className="text-xs text-slate-600">
            Confira as opÃ§Ãµes de contrataÃ§Ã£o por perÃ­odo para <strong>{providerName}</strong>. 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
              ...
              <p className="text-[10px] text-slate-500 mt-1 leading-relaxed">
                Ideal para consultas avulsas, pequenos consertos e aulas especÃ­ficas.
              </p>
            </div>

            {/* OpÃ§Ã£o 2: Por Dia / DiÃ¡ria */}
            <div
            ...
            >
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-[10px] font-bold uppercase tracking-wider text-slate-500 flex items-center space-x-1">
                  ...
                  <span>Valor do Dia (DiÃ¡ria)</span>
                </span>
              ...
              <p className="text-[10px] text-slate-500 mt-1 leading-relaxed">
                Jornada completa (atÃ© 8 horas). Perfeito para reformas e atendimentos imersivos.
              </p>
            </div>

            {/* OpÃ§Ã£o 3: Por MÃªs / Mensalidade */}
            <div
            ...
            >
              ...
              <div className="text-lg font-black text-slate-900">
                {pricingTable?.monthlyRate ? (
                  <>R$ {pricingTable.monthlyRate.toFixed(2).replace('.', ',')}<span className="text-xs font-normal text-slate-500">/mÃªs</span></>
                ) : (
                  <span className="text-xs font-semibold text-slate-400">Sob consulta</span>
                )}
              </div>
              <p className="text-[10px] text-slate-500 mt-1 leading-relaxed">
                Mensalidade recorrente para cursos, planos estÃ©ticos ou manutenÃ§Ã£o preventiva.
              </p>
            </div>
          </div>
          ...
          {pricingTable?.pricingNotes && (
            <div className="p-3 bg-amber-50 rounded-xl border border-amber-200 text-xs text-amber-900 flex items-start space-x-2">
              ...
              <div>
                <strong className="block text-amber-950 font-bold">InformaÃ§Ãµes Adicionais de CobranÃ§a:</strong>
          ...
          <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
            <div className="flex items-center space-x-2">
              ...
              <h5 className="font-bold text-xs sm:text-sm text-slate-900">
                Credenciais & HabilitaÃ§Ã£o Profissional
              </h5>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            {credentials.registrationEntity && (
              <div className="flex items-center space-x-2 text-slate-700">
                ...
                <span>Ã“rgÃ£o Fiscalizador: <strong>{credentials.registrationEntity}</strong></span>
              </div>
            )}
            ...
            {credentials.experienceYears && (
              <div className="flex items-center space-x-2 text-slate-700">
                ...
                <span>ExperiÃªncia Comprovada: <strong>{credentials.experienceYears} anos</strong> em Macacu</span>
              </div>
            )}
            ...
            {credentials.warrantyInfo && (
              <div className="sm:col-span-2 flex items-start space-x-2 text-slate-700 p-2.5 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <div>
                  <strong className="block text-slate-900">Garantia & EmissÃ£o Fiscal:</strong>
      ...
      {/* ReferÃªncias Profissionais para TransparÃªncia Total */}
      {references && references.length > 0 && (
        <div className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-5 shadow-xs space-y-3">
          <div className="flex items-center space-x-2 border-b border-slate-100 pb-2.5">
            ...
            <div>
              <h5 className="font-bold text-xs sm:text-sm text-slate-900">
                ReferÃªncias Profissionais Verificadas
              </h5>
