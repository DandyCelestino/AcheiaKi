  ...
  return (
    <div id="delivery-approval-queue-view" className="space-y-6">
      ...
      {filteredRides.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredRides.map((ride) => {
            ...
            const platformCut = ride.platformFeeApplied || (totalFee - driverEarnings) || platformFee;
      ...
      {approvingRide && (() => {
        ...
        const recalculated = calculateDeliveryPricing(distance, ratePerKm, platformFee);
                ...
                <div className="bg-slate-950/80 p-4 rounded-xl border border-indigo-500/20 space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-3 text-center">
                    ...
                    <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800">
                      ...
                      <div className="text-[10px] text-slate-500">+ R$ {platformFee.toFixed(2)} taxa</div>
                    </div>
                  </div>
                </div>
