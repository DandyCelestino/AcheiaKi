...
export const DeliveryRegisterModal: React.FC<DeliveryRegisterModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      ...
      triggerToast('Cadastro enviado para análise com sucesso!');
    } else {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-emerald-300">
                Achei Aqui Delivery • Cachoeiras de Macacu, RJ
              </p>
            </div>
          </div>
          <button
          ...
          {isSubmittedSuccess ? (
            <div className="p-8 text-center space-y-4">
              ...
              <p className="text-xs text-slate-600 max-w-md mx-auto leading-relaxed">
                Seus dados e documentos foram enviados para análise da equipe Master Achei Aqui. Assim que seus documentos forem conferidos e aprovados, você poderá fazer login e ficar <strong>ONLINE</strong> para aceitar corridas remuneradas em Cachoeiras de Macacu.
              </p>
              <div className="pt-2">
                <button
                  type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-xl text-[11px] text-emerald-950">
                <strong>Ganhos Claros na V1:</strong> Você recebe R$ 1,00 por KM rodado com repasse direto via PIX. A plataforma conecta você aos lojistas da cidade.
              </div>
              ...
              <div className="space-y-3 pt-2">
                <span className="text-[11px] font-black text-slate-900 uppercase block border-b border-slate-100 pb-1">
                  2. Documentação & Veículo
                </span>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase block mb-1">Número CNH *</label>
                    <input
                      type="text"
                      required
                      value={cnhNumber}
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase block mb-1">Tipo de Veículo</label>
                    <select
                      value={vehicleType}
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase block mb-1">Placa do Veículo *</label>
                    <input
                      type="text"
                      required
                      value={vehiclePlate}
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-slate-500 uppercase block mb-1">Cor do Veículo</label>
                    <input
                      type="text"
                      value={vehicleColor}
