...
export const SellerFirstAccessView: React.FC = () => {
  ...
  // 2. A nova senha NÃO pode ser "12345678"
  // 3. Confirmação deve ser exatamente igual à nova senha
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Validação 1: Tentativa de usar a senha padrão 12345678
    if (isDefaultPassword) {
      setErrorMessage('Você precisa cadastrar uma nova senha diferente da senha padrão.');
      return;
    }
    ...
    // Validação 3: Confirmação igual
    if (!isMatch) {
      setErrorMessage('A confirmação da senha deve ser exatamente igual à nova senha digitada.');
      return;
    }
  ...
  return (
    ...
    >
      ...
      <main className="max-w-md w-full mx-auto my-auto">
        <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="bg-linear-to-r from-slate-900 via-indigo-950 to-slate-900 text-white p-6 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-2">
              <div className="inline-flex items-center space-x-2 bg-indigo-500/20 border border-indigo-500/40 text-indigo-300 px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wider">
                ...
                <span>Troca Obrigatória de Senha</span>
              </div>
              ...
              <p className="text-xs text-slate-300 leading-relaxed">
                Bem-vindo à equipe comercial! Para liberar o acesso ao seu Portal do Vendedor, cadastre uma nova senha pessoal e segura.
              </p>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            {/* Notificação de Diretriz de Segurança */}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Digite sua nova senha (mínimo 8 dígitos)"
            ...
            {/* Checklist Visual de Regras de Validação */}
            <div className="p-3 bg-slate-50 border border-slate-200 rounded-2xl space-y-1.5 text-xs">
              ...
              >
                ...
                />
                <span>Diferente da senha padrão (12345678)</span>
              </div>
            ...
            >
              ...
              <span>{isSubmitting ? 'Confirmando Alteração...' : 'CONFIRMAR ALTERAÇÃO & LIBERAR PORTAL'}</span>
      ...
      <footer className="max-w-md w-full mx-auto text-center py-2 text-[11px] text-slate-500">
        Achei Aqui Comercial • Cachoeiras de Macacu - RJ • Autenticação Segura
      </footer>
    </div>
  );
};
