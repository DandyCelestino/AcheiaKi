    ...
    <div id="commercial-hierarchy-manager" className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-xs border border-slate-200">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h2 className="text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
                  Gestão de Hierarquia & Atribuição de Áreas
                  <span className="text-[11px] font-bold px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200">
                    Controle Central Master
                  </span>
                </h2>
                <p className="text-xs text-slate-500 mt-0.5">
                  Organize consultores sob supervisores regionais, atribua territórios em Cachoeiras de Macacu e monitore o desempenho de cada squad comercial.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-5">
          ...
          <div className="bg-slate-50 rounded-xl p-3.5 border border-slate-100">
            <div className="flex items-center justify-between text-xs text-slate-500 mb-1">
              <span>Áreas / Territórios</span>
              <MapPin className="w-4 h-4 text-emerald-600" />
            </div>
            <div className="text-xl font-black text-slate-900">{totalAreas}</div>
            <div className="text-[11px] text-slate-500 mt-0.5">Regiões delimitadas</div>
          </div>
          ...
          <div className="bg-slate-50 rounded-xl p-3.5 border border-slate-100">
            ...
            <div className="text-[11px] text-slate-500 mt-0.5">Comércios & prestadores ativos</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-2 rounded-xl border border-slate-200">
        <div className="flex items-center gap-1">
          ...
          >
            ...
            <span>Esquadrões & Supervisores</span>
          </button>
          ...
          >
            ...
            <span>Territórios & Áreas ({commercialAreas.length})</span>
          </button>
        ...
        <div className="text-xs text-slate-500 px-3 flex items-center gap-1.5 font-medium">
          ...
          Master Supremo: Gestão hierárquica centralizada
        </div>
      </div>

      {/* ========================================================================= */}
      {/* VIEW 1: ESQUADRÕES & SUPERVISORES (SQUAD VIEW) */}
      {/* ========================================================================= */}
      {viewMode === 'squads' && (
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          title="Reatribuir líder / alterar cargo"
                    ...
                    {subordinates.length === 0 ? (
                      <div className="text-center py-6 px-4 bg-slate-50 rounded-xl border border-dashed border-slate-200">
                        <p className="text-xs text-slate-500">
                          Nenhum consultor atribuído a este supervisor no momento.
                        </p>
                        <button
                          onClick={() => {
                              ...
                              <div className="flex items-center space-x-3 min-w-0">
                                ...
                                <div className="min-w-0">
                                  ...
                                  <p className="text-[11px] text-slate-500 truncate flex items-center gap-1 mt-0.5">
                                    ...
                                    {sub.assignedRegion} • {clientsCount} clientes ativos
                                  </p>
                                </div>
                              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-indigo-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Consultores e coordenadores que respondem diretamente ao Master sem supervisão intermediária.
                  </p>
                </div>
              </div>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <button
                        ...
                        title="Atribuir a um supervisor ou alterar área"
      ...
      {/* ========================================================================= */}
      {/* VIEW 2: TERRITÓRIOS & ÁREAS COMERCIAIS (AREA VIEW) */}
      {/* ========================================================================= */}
      {viewMode === 'areas' && (
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-slate-200">
            <div>
              <h3 className="font-extrabold text-sm text-slate-900">
                Divisão Territorial de Cachoeiras de Macacu
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">
                Regiões de atuação comercial com atribuição de supervisor e equipe dedicada de consultores.
              </p>
            </div>
            <button
              onClick={openNewAreaModal}
            ...
            >
              <Plus className="w-4 h-4" />
              <span>Adicionar Área / Distrito</span>
            </button>
          </div>
                ...
                >
                  <div className="p-5">
                    ...
                    <div className="flex items-start justify-between gap-2 mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          onClick={() => {
                            if (confirm(`Deseja realmente excluir a área "${area.name}"?`)) {
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100 text-center">
                      <div className="bg-slate-50 p-2 rounded-lg">
                        <span className="text-[10px] text-slate-500 block">Vendedores na Área</span>
                        <span className="text-xs font-extrabold text-slate-800">
                          {areaAgents.length} consultores
                        </span>
                      </div>
                      <div className="bg-slate-50 p-2 rounded-lg">
                        <span className="text-[10px] text-slate-500 block">Meta Ativações</span>
                        <span className="text-xs font-extrabold text-blue-700">
                          {area.targetMonthlyActivations} / mês
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-3 bg-slate-50 border-t border-slate-100 flex items-center justify-between text-xs">
                    <span className="text-slate-500 text-[11px]">
                      {clientsInArea.length} cadastros no histórico
                    </span>
                    <button
                      onClick={() => openEditAreaModal(area)}
      ...
      {/* ========================================================================= */}
      {/* VIEW 3: MATRIZ DE ATRIBUIÇÃO RÁPIDA (MATRIX TABLE) */}
      {/* ========================================================================= */}
      {viewMode === 'matrix' && (
          ...
          <div className="p-4 border-b border-slate-100 bg-slate-50/60 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                ...
                <option value="CONSULTOR_SENIOR">Consultor Sênior</option>
                <option value="CONSULTOR_JUNIOR">Consultor Júnior</option>
              </select>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 text-[11px] font-extrabold text-slate-500 uppercase tracking-wider border-b border-slate-200">
                  ...
                  <th className="py-3.5 px-4">Nível & Cargo</th>
                  <th className="py-3.5 px-4">Supervisor Imediato</th>
                  <th className="py-3.5 px-4">Área / Território</th>
                  <th className="py-3.5 px-4">Meta Mês</th>
                  <th className="py-3.5 px-4">Comissão Fixada</th>
                  <th className="py-3.5 px-4 text-right">Ação Master</th>
                </tr>
              </thead>
      ...
      {/* ========================================================================= */}
      {/* MODAL: ATRIBUIÇÃO & HIERARQUIZAÇÃO DE VENDEDOR */}
      {/* ========================================================================= */}
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="font-black text-base text-slate-900">
                    Hierarquização & Atribuição de Vendedor
                  </h3>
                  <p className="text-xs text-slate-500">
                    Defina subordinação, área de atuação e metas no organograma Master.
                  </p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleSaveAssignment} className="p-6 space-y-4">
              ...
              <div className="p-3 bg-blue-50/60 rounded-xl border border-blue-100 flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {agentToAssign.email} • {agentToAssign.phone}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">Nível Hierárquico no Organograma</label>
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (newLevel === 'COORDENADOR_REGIONAL') {
                      ...
                      setAssignRoleTitle('Supervisor de Vendas e Expansão');
                    } else if (newLevel === 'CONSULTOR_SENIOR') {
                      setAssignRoleTitle('Consultor Comercial Sênior');
                    } else {
                      setAssignRoleTitle('Consultor Comercial Júnior');
                    }
                  }}
                ...
                >
                  <option value="COORDENADOR_REGIONAL">Coordenador Regional (Nível 1 - Lidera Supervisores)</option>
                  <option value="SUPERVISOR_VENDAS">Supervisor de Vendas (Nível 2 - Lidera Consultores)</option>
                  <option value="CONSULTOR_SENIOR">Consultor Comercial Sênior (Nível 3 - Campo)</option>
                  <option value="CONSULTOR_JUNIOR">Consultor Comercial Júnior (Nível 3 - Campo / Trainee)</option>
                </select>
              </div>

              {/* TÍTULO DO CARGO */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">Título Personalizado do Cargo</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">
                  Supervisor Imediato (Linha de Subordinação)
                </label>
                <select
                  ...
                  className="w-full px-3 py-2 text-xs rounded-xl border border-slate-300 focus:outline-hidden focus:border-blue-600 font-medium"
                >
                  <option value="">Reporte Direto ao Administrador Master Supremo (Sem intermediário)</option>
                  {leaders
                ...
                <p className="text-[11px] text-slate-500">
                  Ao selecionar um supervisor, o vendedor aparecerá automaticamente agrupado sob o esquadrão dele.
                </p>
              </div>

              {/* ÁREA / TERRITÓRIO ATRIBUÍDO */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">Área / Território de Atuação</label>
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    <option value="Centro & Japuíba">Centro & Japuíba</option>
                    <option value="Papucaia & Agrobrasil">Papucaia & Agrobrasil</option>
                    <option value="Guapiaçu & Castália">Guapiaçu & Castália</option>
                    <option value="Valério & Funchal">Valério & Funchal</option>
                    <option value="Boca do Mato & Ribeira">Boca do Mato & Ribeira</option>
                    <option value="Toda a Região Municipal">Toda a Região Municipal</option>
                  </select>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-700">Comissão Fixada (%)</label>
                  <input
                    type="number"
                    min="1"
                    max="100"
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2">
                ...
                >
                  ...
                  <span>Salvar Atribuição Master</span>
                </button>
              </div>
            </form>
          </div>
      ...
      {/* ========================================================================= */}
      {/* MODAL: CRIAÇÃO / EDIÇÃO DE ÁREA COMERCIAL */}
      {/* ========================================================================= */}
      {isAreaModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="font-black text-base text-slate-900">
                    {areaToEdit ? 'Editar Área Comercial' : 'Nova Área / Território Comercial'}
                  </h3>
                  <p className="text-xs text-slate-500">
            ...
            <form onSubmit={handleSaveArea} className="p-6 space-y-4">
              <div className="grid grid-cols-3 gap-3">
                <div className="col-span-2 space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Nome da Área / Região</label>
                  <input
                    type="text"
                    required
                    value={areaName}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Meta Mensal da Área</label>
                  <input
                    type="number"
                    min="1"
                    value={areaTarget}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Cor de Identificação</label>
                  <div className="flex items-center gap-2">
                    <input
                      type="color"
                      value={areaColor}
              ...
              {/* NOTAS */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">Anotações Estratégicas</label>
                <textarea
                  rows={2}
                  value={areaNotes}
                  onChange={(e) => setAreaNotes(e.target.value)}
                  placeholder="Ex: Polo forte em agronegócio, serviços mecânicos e turismo ecológico..."
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-2">
                ...
                >
                  <CheckCircle2 className="w-4 h-4" />
                  <span>{areaToEdit ? 'Salvar Alterações' : 'Criar Área Comercial'}</span>
                </button>
              </div>
            </form>
          </div>
